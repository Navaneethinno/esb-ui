  ...
  return (
    PLACEHOLDER_SECTION
              ...
              {!oneToManyEnabled ? (
                ...
                <div className="field">
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                    <label style={{ marginBottom: 0 }}>Outbound Request Type</label>
                    <button
                      type="button"
                      className="btn-ghost"
                  ...
                  {outboundRequestSelections.slice(1).length > 0 && (
                    <div style={{ marginTop: 10, paddingTop: 10, borderTop: "1px dashed var(--border)" }}>
                      {outboundRequestSelections.slice(1).map((value, extraIndex) => (
                        <div key={extraIndex} style={{ marginTop: extraIndex === 0 ? 12 : 8, display: "grid", gridTemplateColumns: "1fr auto", gap: 10, alignItems: "center" }}>
                          <select
                            value={value}
                            onChange={(e) => {
                              const next = e.target.value;
                          ...
                          <button
                            ...
                            style={{ minWidth: 44, height: 44, display: "inline-flex", alignItems: "center", justifyContent: "center", opacity: 1, flexShrink: 0 }}
                          >
          ...
          <IntegrationFlowCard
            ...
            outboundRequestNames={outboundRequestSelections}
          />
        ...
        <section className="la-section" style={{ marginTop: 28 }}>
          <div className="la-section-heading">
            ...
            <div>
              <h3 className="la-section-title" style={{ marginBottom: 6 }}>{inboundAdapterName} to {outboundAdapterName}</h3>
              <p className="la-section-sub">Map {outboundAdapterName} response fields to {inboundAdapterName} response fields</p>
            </div>
          </div>
          <MappingStudio
